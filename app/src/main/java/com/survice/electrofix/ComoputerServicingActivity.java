...
public class ComoputerServicingActivity extends BaseActivity { // Or AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_servicing);
        ...
        btnBack.setOnClickListener(v -> {
            startActivity(new Intent(ComoputerServicingActivity.this, CategoryActivity.class));
        });
// ⭐ UPDATED PART: Pass data for each service
    ...
    private void navigateToBooking(String categoryTitle, String serviceTitle, String price, String priceDescription) {
        Intent intent = new Intent(ComoputerServicingActivity.this, BookingActivity.class);
